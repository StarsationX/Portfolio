...
const projects = [
  ...
  },
  {
    ...
    description:
      "An application that uses AI to generate content for various purposes including blog posts and social media.",
    image: "/placeholder.svg?height=400&width=600",
  ...
  },
  {
    ...
    description: "A real-time analytics dashboard with data visualization and filtering capabilities.",
    image: "/placeholder.svg?height=400&width=600",
